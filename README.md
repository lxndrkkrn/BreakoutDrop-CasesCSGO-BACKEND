...
- Spring Data JPA, PostgresSQL, pgAdmin 4
- Lombok, Slf4j
- Docker
...
- Применение промо-кодов для P2P пополнению
- Авторизация на сайте (+ Куки)

### Нововведения:
- Возможность получить список всех кейсов (для фронтенда)
- Возможность получить данные о кейсе по id
